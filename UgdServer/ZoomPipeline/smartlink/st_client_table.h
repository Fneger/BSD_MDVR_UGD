...
namespace ExampleServer{
	...
	public:
        ...
        st_clientNode_baseTrans * clientNodeFromUUID(quint64);
		st_clientNode_baseTrans * clientNodeFromSocket(QObject *);
        st_clientNode_baseTrans * clientNodeFromEventInfo(const EVENT_INFO_S &event);
	...
	protected:
		...
		QMutex m_hash_mutex;
        std::unordered_map<quint64,st_clientNode_baseTrans *> m_hash_uuid2node;
